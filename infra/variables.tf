...
variable "domain_contact_email" {
  type    = string
  default = "afnanjk2017@gmail.com"
}
variable "domain_contact_phone" { # E.164 format, e.g. +1.5555555555
  type    = string
  default = "+1.5555555555"
}
variable "domain_contact_address1" {
  type    = string
  default = "123 Azure Lane"
}
...
variable "domain_contact_postal" {
  type    = string
  default = "11451"
}
variable "domain_contact_country" { # ISO code, e.g. US, SA
  type    = string
  default = "SA"
}
